...
export default function RelationshipIntelligenceSection() {
  ...
  return (
    ...
    >
      {/* Ambient drifting blooms for atmospheric volume */}
      ...
      <div className="container" style={{ position: "relative", zIndex: 1 }}>
        ...
        {/* Blueprint Layout Grid Wrapper with Side Margins and Corner Crosshairs */}
        <div style={{ position: "relative", maxWidth: "1040px", margin: "0 auto", padding: "16px" }}>
          ...
          <div style={{ 
            ...
            borderRadius: "24px",
            boxShadow: "0 15px 45px -10px rgba(0, 0, 0, 0.04)",
            padding: "32px",
            overflow: "hidden",
